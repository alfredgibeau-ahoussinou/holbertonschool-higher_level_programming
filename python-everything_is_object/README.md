...
- [Mutation](https://docs.python.org/3/reference/datamodel.html#objects-values-and-types)
- [9.12. Cloning lists](https://docs.python.org/3/reference/datamodel.html#objects-values-and-types)
- [Python tuples: immutable but potentially changing](https://docs.python.org/3/reference/datamodel.html#objects-values-and-types)
